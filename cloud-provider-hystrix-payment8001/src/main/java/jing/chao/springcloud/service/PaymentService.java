...
public class PaymentService {
     ...
     * @return
     */
    @HystrixCommand(fallbackMethod = "paymentTimeoutHandle", commandProperties = {@HystrixProperty(name = "execution.isolation.thread.timeoutInMilliseconds", value = "3000")})
    public String paymentHystrixTimeout(Long id) {
        ...
        return "线程池:" + Thread.currentThread().getName() + " paymentHystrixTimeout,id: " + id;
    }

    public String paymentTimeoutHandle(Long id) {
        return "线程池:" + Thread.currentThread().getName() + " 系统繁忙或运行错误,请稍后重试,id: " + id + " 超时";
    }
